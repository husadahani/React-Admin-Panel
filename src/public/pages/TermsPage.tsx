  ...
  return (
    <PublicLayout>
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 dark:text-white">Terms of Service</h1>
        ...
        <div className="prose max-w-none dark:prose-invert">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Interpretation and Definitions</h2>
          
          <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Interpretation</h3>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <ul className="list-disc list-inside text-gray-600 mb-6 space-y-2 dark:text-gray-300">
            <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
            <li><strong>Country</strong> refers to: Indonesia</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Flazz.</li>
            <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
            <li><strong>Service</strong> refers to the Website.</li>
            <li><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.</li>
            <li><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</li>
            <li><strong>Website</strong> refers to Flazz, accessible from https://flazz.com</li>
            <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
          </ul>
          
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Acknowledgment</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Links to Other Websites</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Termination</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <p className="text-gray-600 mb-4 dark:text-gray-300">
            ...
            the Service, or otherwise in connection with any provision of this Terms), even 
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
            ...
            to the Service, including all implied warranties of merchantability, fitness for 
            a particular purpose, title and non-infringement, and warranties that may arise 
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Governing Law</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
            The laws of the Country, excluding its conflicts of law provisions, shall govern 
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Disputes Resolution</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">For European Union (EU) Users</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
            If You are a European Union consumer, you will benefit from any mandatory 
            provisions of the law of the country in which you are resident in.
          </p>
          
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">United States Legal Compliance</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Severability and Waiver</h2>
          
          <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Severability</h3>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Waiver</h3>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Translation Interpretation</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Changes to These Terms and Conditions</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <ul className="list-disc list-inside text-gray-600 mt-2 dark:text-gray-300">
            <li>By email: legal@flazz.com</li>
            <li>By visiting this page on our website: https://flazz.com/contact</li>
          </ul>
        </div>
      </div>
    </PublicLayout>

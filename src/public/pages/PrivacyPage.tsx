    ...
    <PublicLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="prose max-w-none dark:prose-invert">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Collecting and Using Your Personal Data</h2>
          
          <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Types of Data Collected</h3>
          
          <h4 className="text-lg font-semibold mb-2 text-gray-800 dark:text-white">Personal Data</h4>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h4 className="text-lg font-semibold mb-2 text-gray-800 dark:text-white">Usage Data</h4>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Use of Your Personal Data</h2>
          <p className="text-gray-600 mb-2 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Retention of Your Personal Data</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Disclosure of Your Personal Data</h2>
          <p className="text-gray-600 mb-2 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Security of Your Personal Data</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Children's Privacy</h2>
          <p className="text-gray-600 mb-4 dark:text-gray-300">
          ...
          <ul className="list-disc list-inside text-gray-600 mt-2 dark:text-gray-300">
            <li>By email: privacy@flazz.com</li>
